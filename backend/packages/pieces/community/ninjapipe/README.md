...
## Wiring
- Add `"@activepieces/piece-ninjapipe": ["backend/packages/pieces/community/ninjapipe/src/index.ts"]` alphabetically into the root `tsconfig.base.json` `compilerOptions.paths`.
