...
<Info>
This playbook is specifically about **full-stack browser E2E tests using Playwright** in `frontend/packages/tests-e2e/`. For the canonical 4-layer testing taxonomy across the whole monorepo (unit / integration / e2e / smoke) — and to decide whether your test actually belongs at the E2E layer at all — see the [Testing Strategy playbook](/handbook/engineering/playbooks/testing-strategy).
</Info>
