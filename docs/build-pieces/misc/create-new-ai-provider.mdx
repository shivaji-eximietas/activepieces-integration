...
Create a new factory that returns an instance of the `AI` interface in the `backend/packages/pieces/common/src/lib/ai/providers/your-ai-provider.ts` file.
...
Add the new AI provider to the `AiProviders` enum in `backend/packages/pieces/common/src/lib/ai/providers/index.ts` file.
