...
For a full working example, see the [text-helper piece tests on GitHub](https://github.com/activepieces/activepieces/tree/main/backend/packages/pieces/core/text-helper/test).
...
cd backend/packages/pieces/core/text-helper
npx vitest run
```
