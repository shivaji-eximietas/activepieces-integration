...
Use the CLI to sync items from `backend/packages/pieces/custom/` to instances. In production, Activepieces acts as an npm registry, storing all piece versions.
