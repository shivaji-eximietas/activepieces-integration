...
<Steps>
  ...
  <Step title="Translate">
     Make a copy of `backend/packages/pieces/<community_or_custom>/<your_piece>/src/i18n/translation.json`, name it `<locale>.json` i.e fr.json and translate the values.
    <Tip>
