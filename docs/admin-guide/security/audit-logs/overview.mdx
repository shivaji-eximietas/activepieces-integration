...
The full list of documented events. We add new ones as the platform grows; the source of truth for every event we emit is the [event schema in the codebase](https://github.com/activepieces/activepieces/blob/main/backend/packages/shared/src/lib/ee/audit-events/index.ts).
